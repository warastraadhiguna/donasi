                            ...
                            <div class="custom-block-wrap program-card" data-aos="fade-up" data-aos-delay="{{ $loop->index * 120 }}">
                                ...
                                <div class="custom-block">
                                    ...
                                    <div class="program-card-actions">
                                        ...
                                        <a href="https://wa.me/?text={{ rawurlencode('Yuk bantu program ' . $program->title . ': ' . (is_file(public_path('share-preview/' . $program->slug . '.html')) ? url('share-preview/' . $program->slug . '.html') : route('program.share', $program))) }}" class="custom-btn custom-border-btn btn share-whatsapp-btn" target="_blank" rel="noopener noreferrer">
